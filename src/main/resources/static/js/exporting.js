...
(function (a) {
    ...
    a = a ? a._modules : {};
    k(a,
        "Core/Chart/ChartNavigationComposition.js", [], function () {
            var a;
            (function (a) {
    ...
    k(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"]], function (a) {
        ...
        return {
            exporting: {
                ...
                exitFullscreen: "Выйти со всего экрана",
    ...
    k(a, "Extensions/Exporting/ExportingSymbols.js", [], function () {
        ...
        (function (a) {
            function b(a, b, d, l) {
                return [["M", a, b + 2.5], ["L", a + d, b + 2.5], ["M", a, b + l / 2 + .5], ["L", a + d, b + l / 2 + .5], ["M", a, b + l - 1.5], ["L", a + d, b + l - 1.5]]
            }
    ...
    k(a, "Extensions/Exporting/Fullscreen.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Utilities.js"]], function (a, b) {
        ...
        var k = b.addEvent, n = b.fireEvent, z = [], A = function () {
            function b(a) {
                this.chart = a;
                this.isOpen = !1;
                a = a.renderTo;
            ...
            b.prototype.close = function () {
                var a = this, b = a.chart, f = b.options.chart;
                n(b, "fullscreenClose", null, function () {
                    ...
                    b.setSize(a.origWidth, a.origHeight,
                        !1);
                    a.origWidth = void 0;
                    a.origHeight = void 0;
            ...
            b.prototype.setButtonText = function () {
                var b = this.chart, h = b.exportDivElements, f = b.options.exporting,
    ...
    k(a, "Core/HttpUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, b) {
        var k = a.doc, t = b.createElement, n = b.discardElement, z = b.merge, A = b.objectEach, d = {
            ajax: function (a) {
                ...
                d.ajax({url: a, success: b, dataType: "json", headers: {"Content-Type": "text/plain"}})
            }, post: function (a, b, f) {
                var d = t("form", z({
                    method: "post",
                    action: a,
                    enctype: "multipart/form-data"
                }, f), {display: "none"}, k.body);
                A(b, function (a, b) {
                    t("input", {type: "hidden", name: b, value: a}, void 0, d)
                });
                d.submit();
                n(d)
            }
    ...
    k(a, "Extensions/Exporting/Exporting.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Chart/Chart.js"], a["Core/Chart/ChartNavigationComposition.js"], a["Core/DefaultOptions.js"], a["Extensions/Exporting/ExportingDefaults.js"], a["Extensions/Exporting/ExportingSymbols.js"], a["Extensions/Exporting/Fullscreen.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Utilities.js"]], function (a, b, k, D, n, z, A, d, l, h) {
        b = D.defaultOptions;
        var f = d.doc, t = d.SVG_NS, x = d.win, B = h.addEvent, v = h.css, u = h.createElement,
            J = h.discardElement, E = h.extend, N = h.find, F = h.fireEvent, O = h.isObject, p = h.merge,
            P = h.objectEach, q = h.pick, Q = h.removeEvent, R = h.uniqueKey, G;
        (function (b) {
            function n(a) {
                var c = this, b = c.renderer, g = p(c.options.navigation.buttonOptions, a), f = g.onclick,
                    C = g.menuItems, d = g.symbolSize || 12;
                ...
                if (!1 !== g.enabled && g.theme) {
                    ...
                    var r = b.button(g.text, 0, 0, I, e).addClass(a.className).attr({title: q(c.options.lang[g._titleKey || g.titleKey], "")});
                    ...
                    r.add(c.exportingGroup).align(E(g, {width: r.width, x: q(g.x, c.buttonOffset)}), !0, "spacingBox");
            ...
            function D() {
                if (this.printReverseInfo) {
                    var a = this.printReverseInfo,
                        b = a.childNodes, w = a.origDisplay;
                    a = a.resetParams;
            ...
            function G() {
                var a = f.body, b = this.options.exporting.printMaxWidth,
                    w = {childNodes: a.childNodes, origDisplay: [], resetParams: void 0};
                this.isPrinting = !0;
            ...
            function T(c, b, w, g, d, C, k) {
                var e = this, y = e.options.navigation, r = e.chartWidth, K = e.chartHeight, t = "cache-" + c,
                    l = Math.max(d, C), m = e[t];
                if (!m) {
                    e.exportContextMenu = e[t] = m = u("div", {className: c}, {
                        position: "absolute",
                        zIndex: 1E3, padding: l + "px", pointerEvents: "auto"
                    }, e.fixedDiv || e.container);
                    var p = u("ul", {className: "highcharts-menu"}, {listStyle: "none", margin: 0, padding: 0}, m);
                    e.styledMode || v(p, E({
                    ...
                    m.hideMenu = function () {
                        ...
                        k && k.setState(0);
                        e.openMenu = !1;
                        v(e.renderTo, {overflow: "hidden"});
                        v(e.container, {overflow: "hidden"});
                    ...
                    b.forEach(function (c) {
                        ...
                        if (O(c, !0)) {
                            ...
                            }, v(b, E({cursor: "pointer"}, y.menuItemStyle || {}))));
                ...
                v(m, b);
                v(e.renderTo, {overflow: ""});
                v(e.container, {overflow: ""});
                e.openMenu = !0;
                F(e, "exportMenuShown")
            }

            function U(a) {
                var c = a ? a.target : this, b = c.exportSVGElements, g = c.exportDivElements;
                a = c.exportEvents;
                var d;
            ...
            function Y(a) {
                ...
                }, f.body), d = this.renderTo.style.width;
                ...
                E(c.chart, {animation: !1, renderTo: g, forExport: !0, renderer: "SVGRenderer", width: d, height: h});
                c.exporting.enabled =
                    !1;
                delete c.data;
                c.series = [];
                ...
                this.axes.forEach(function (a) {
                    ...
                    a.options.isInternal || (k[a.coll] || (k[a.coll] = !0, c[a.coll] = []), c[a.coll].push(p(a.userOptions, {visible: a.visible})))
                });
            ...
            function Z(a, b) {
                ...
                return this.getSVG(p({chart: {borderRadius: 0}}, c.chartOptions,
                    b, {
                        exporting: {
            ...
            function ba() {
                function a(b) {
                    ...
                    if (n && 1 === b.nodeType && -1 === ca.indexOf(b.nodeName)) {
                        ...
                        for (var t in l) if (d.isFirefox || d.isMS || d.isSafari || Object.hasOwnProperty.call(l, t)) {
                            var u = l[t], q = t;
                            m = e = !1;
                            if (h.length) {
                ...
                var y = da, h = b.inlineWhitelist, g = {}, k, l = f.createElement("iframe");
                v(l, {width: "1px", height: "1px", visibility: "hidden"});
            ...
            function ea(a) {
                (this.fixedDiv ? [this.fixedDiv, this.scrollingContainer] :
                    [this.container]).forEach(function (b) {
                    a.appendChild(b)
                })
            }
            ...
            function ia() {
                ...
                g && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({zIndex: 3}).add(), P(d, function (b) {
                    a.addButton(b)
